...
const Navbar = () => {
    ...
    return (
        <div className="lg:flex justify-between md:px-32 px-4 p-4 bg-[#F6F6F6] items-center">
            ...
            <ul className={`lg:flex left-0 p-4 lg:p-0 gap-10 items-center absolute lg:z-auto bg-white w-full lg:static transition-all duration-500 ease-in ${!open ? "top-20" : "top-[-500px]"}`}>
